...
**В данный проект внесена доработка.**

В само приложение добавлена кнопка воспрозведения распознаных нот и появилась возможность сразу прослушать как эта мелодия звучит на глюкофоне.

<img width="1050" height="896" alt="image" src="https://github.com/user-attachments/assets/74f940ff-deec-42a1-b105-3214bd33c53d" />

Также создан **телеграмм-бот @glucophone_bot** (модель не размещена на облачном сервере, поэтому проверить работу бота можно при включении - попросте меня и я включу)

Схема работы бота отличается от схемы работы приложения из-за отсутствия функционала на стороне Телеграмм.

Бот просить загрузить фотограию - распознаёт ноты - при нажатии на кнопку "проиграть мелодию" - формирует mp3 файл с очередностью нот, которые распознал

Все действия сопровождаютс текстовыми сообщениями, которые в последствии исчезают.

<img width="962" height="902" alt="image" src="https://github.com/user-attachments/assets/4996cd4d-56a0-4d1d-8d8e-ab3efbd8b374" />
